...
class QuestionListenAdapter (val context: Context, val question: QuestionListenModel) :
    RecyclerView.Adapter<QuestionListenAdapter.QuestionViewHolder>() {

    private var options: List<String> = listOf(question.optA, question.optB, question.optC, question.optD)


    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): QuestionListenAdapter.QuestionViewHolder {
