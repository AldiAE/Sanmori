...
class PenggalangRakitAdapter internal constructor(private val activity: Activity) : RecyclerView.Adapter<PenggalangRakitAdapter.PenggalangViewHolder>() {
    private val listPenggalangRakit = ArrayList<PenggalangEntity>()

    fun setListPenggalangRakit(listPenggalangRakit: List<PenggalangEntity>) {
        val diffCallback = PenggalangDiffCallback(this.listPenggalangRakit, listPenggalangRakit)
        val diffResult = DiffUtil.calculateDiff(diffCallback)
        this.listPenggalangRakit.clear()
        this.listPenggalangRakit.addAll(listPenggalangRakit)
    ...
    override fun onBindViewHolder(holder: PenggalangViewHolder, position: Int) {
        holder.bind(listPenggalangRakit[position])
    }
    override fun getItemCount(): Int {
        return listPenggalangRakit.size
    }
