...
class PenggalangRamuAdapter internal constructor(private val activity: Activity) : RecyclerView.Adapter<PenggalangRamuAdapter.PenggalangViewHolder>() {
    private val listPenggalangRamu = ArrayList<PenggalangEntity>()


    fun setListPenggalangRamu(listPenggalangRamu: List<PenggalangEntity>) {
        val diffCallback = PenggalangDiffCallback(this.listPenggalangRamu, listPenggalangRamu)
        val diffResult = DiffUtil.calculateDiff(diffCallback)
        this.listPenggalangRamu.clear()
        this.listPenggalangRamu.addAll(listPenggalangRamu)
    ...
    override fun onBindViewHolder(holder: PenggalangViewHolder, position: Int) {
        holder.bind(listPenggalangRamu[position])
    }
    override fun getItemCount(): Int {
        return listPenggalangRamu.size
    }
