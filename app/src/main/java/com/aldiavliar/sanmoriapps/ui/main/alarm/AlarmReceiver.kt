package com.aldiavliar.sanmoriapps.ui.main.alarm
...
class AlarmReceiver : BroadcastReceiver() {
    ...
    companion object {
        const val TYPE_ONE_TIME = "Alarm Aplikasi Sanmori"
        const val TYPE_REPEATING = "Alarm Aplikasi Sanmori"
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        val player = MediaPlayer.create(context, R.raw.alarm_clock)
        player.start()
